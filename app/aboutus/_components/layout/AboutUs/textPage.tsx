          ...
          <div className="flex flex-col mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
              <div className=" px-6 py-2 rounded-lg">
                <h2 className="text-xl font-bold mb-2 text-[#090F4A]">Hiring Criteria</h2>
                <ul className="text-gray-700">
                  <li><span className="px-2">1.</span>Tier 2 - 3 Cities</li>
                  <li><span className="px-2">2.</span>Test for drive</li>
                  <li><span className="px-2">3.</span>Test for Service Orientation</li>
                  <li><span className="px-2">4.</span>Test for Intelligence</li>
                </ul>
              </div>
              <div className=" px-6 py-2 rounded-lg">
                <h2 className="text-xl font-bold mb-2 text-[#090F4A]">Process Executive & Delivery Manager</h2>
                <ul className="text-gray-700">
                  <li><p className="font-bold">Internal Certifications:</p></li>
                  <li><span className="px-2">1.</span>Process knowledge - Starter</li>
                  <li><span className="px-2">2.</span>Governance Frameworks - Starter</li>
                  <li><span className="px-2">3.</span>Client Communication Skills - Starter</li>
                </ul>
              </div>
              <div className=" px-6 py-2 rounded-lg">
                <h2 className="text-xl font-bold mb-2 text-[#090F4A]">Account Delivery Manager</h2>
                <ul className="text-gray-700">
                  <li><span className="px-2">1.</span>Process knowledge - Advanced</li>
                  <li><span className="px-2">2.</span>Governance Frameworks - Advanced</li>
                  <li><span className="px-2">3.</span>Client Communication Skills - Advanced</li>
                </ul>
              </div>
              <div className=" px-6 py-2 rounded-lg">
                <h2 className="text-xl font-bold mb-2 text-[#090F4A]">Pod Leader</h2>
                <ul className="text-gray-700">
                  <li><span className="px-2">1.</span>Min 2 Yrs in Account Delivery</li>
                  <li><span className="px-2">2.</span>Eligible to open Independent office in location of choice</li>
                  <li><span className="px-2">3.</span>Profit share</li>
                </ul>
              </div>
            </div>
          </div>
