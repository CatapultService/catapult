      ...
      <div className=" bg-white px-10 md:px-20 text-black flex items-center">
        <div className="mx-auto max-w-6xl my-5">
          ...
          <div className="flex flex-col md:flex-row mb-8 items-start">
            ...
            <p className="text-base leading-relaxed text-left">
              Continous learning programmes based on developments & client
              feedback
            </p>
            <div className="flex flex-row gap-4">
              <img src={Food.src} alt="food" className="w-20 sm:w-40 h-full" />
              <img src={People.src} alt="people" className="w-20 sm:w-40 h-full" />
              <img src={Work.src} alt="work" className="w-20 sm:w-40 h-full" />
            </div>
            </div>
