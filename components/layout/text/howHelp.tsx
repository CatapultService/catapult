...
export default function howHelp() {
  return (
    <div className="w-full bg-[#090E4A]">
      <div className="my-16">
        <p className="mb-6 text-sm sm:text-lg md:text-2xl lg:text-3xl font-bold leading-relaxed mx-auto text-white text-center">
          How We Help Clients
        </p>
      </div>
      <div className="hidden text-white lg:flex ">
        <div
          className="flex-1 p-6 h-80 transition-all bg-black duration-300 hover:flex-[2] bg-cover group flex flex-col justify-between relative"
      ...
      <div className="grid grid-cols-1  sm:grid-cols-2 text-white lg:hidden">
        <div
          className="flex-1 p-6 h-80 transition-all duration-300 hover:flex-[2] bg-cover flex flex-col justify-center "
          style={{ backgroundImage: `url(${FirstImg.src})` }}
        >
