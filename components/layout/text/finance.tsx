      ...
      <div className=" bg-[#021836] px-20 text-white flex items-center">
        <div className="mx-auto max-w-6xl my-4">
          <p className="my-16 text-base sm:text-lg md:text-xl leading-relaxed  mx-auto text-center">
            ...
            dependent on generating insights from data in a timely manner, that
            can be used to make faster and sharper decisions and drive outcomes,
            to grow revenue & profits and
            <br />
          ...
          <p className="my-16 text-base sm:text-lg md:text-xl leading-relaxed mx-auto text-center">
            ...
            readiness, that ensures creation of a &quot;Certified&quot; Single
            source of truth with a Layered Architecture leading to improved
            decision making by providing Clearer, Faster & Richer alerts,
          ...
          <p className="my-16 text-base sm:text-lg md:text-xl  leading-relaxed mx-auto text-center">
            ...
            Looking&quot;, Strategic and Operational choices, while balancing
            pursuit of Growth with Risk Management & Capital Efficiency.
          </p>
        </div>
      </div>
    </>
