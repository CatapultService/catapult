    ...
    <>
      <div className=" bg-white px-10 md:px-20 text-black flex items-center">
        <div className="mx-auto max-w-6xl my-5">
          <p className="my-16 text-base sm:text-lg md:text-xl leading-relaxed mx-auto text-left">
          ...
          <p className="mt-0 mb-16 text-base sm:text-lg md:text-xl  leading-relaxed mx-auto text-left">
